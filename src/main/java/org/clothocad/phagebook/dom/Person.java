 ...
 * @author JohanOspina
 */
public class Person implements ClothoBaseObject{
    ...
    @Getter
    @Setter
    private List<String> phagebookCitations;
    @Getter
    @Setter
    private Map<String, Set<PersonRole>> roles;
    @Getter
    @Setter
    private List<String> createdOrders;
    @Getter
    @Setter
    private List<String> submittedOrders;
    @Getter
    @Setter
    ...
    @Getter
    @Setter
    private List<String> deniedOrders;
    @Getter
    @Setter
    private List<String> colleagueRequests;
